...
public interface IKubernetesClient {
    ...
    /// </summary>
    Task<IEnumerable<KubernetesUpgrade>> GetUpgrades(string clusterId);
    ...
    /// </returns>
    Task<IEnumerable<byte>> GetKubeConfig(string clusterId);
    ...
    /// </summary>
    Task<IEnumerable<KubernetesNodePool>> GetAllNodePools(string clusterId);
