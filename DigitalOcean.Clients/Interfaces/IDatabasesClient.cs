...
public interface IDatabasesClient {
    ...
    /// </summary>
    Task<IEnumerable<DatabaseCluster>> GetAll();

    /// <summary>
    /// Retreive all database clusters on your account by tag
    /// </summary>
    Task<IEnumerable<DatabaseCluster>> GetAllByTag(string tag);
    ...
    /// </summary>
    Task<IEnumerable<DatabaseBackup>> GetBackups(string databaseId);
    ...
    /// </summary>
    Task<IEnumerable<DatabaseReplica>> GetAllReplicas(string databaseId);
    ...
    /// </summary>
    Task<IEnumerable<DatabaseUser>> GetAllUsers(string databaseId);
    ...
    /// </summary>
    Task<IEnumerable<Database>> GetAllDatabases(string databaseId);
    ...
    /// </summary>
    Task<IEnumerable<ConnectionPool>> GetAllConnectionPools(string databaseId);
    ...
    /// </summary>
    Task<IEnumerable<DatabaseFirewallRule>> ListFirewallRules(string databaseId);
